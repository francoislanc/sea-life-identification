...
<div class="h-full">
	<div class="container p-8 mx-auto">
		...
		<h4 class="h4 py-4">The Purposes for Which We Use The Data</h4>
		<p>
			We use the images/videos you reported in the App to improve the App. In particular, it could
			be used to improve a machine learning model that do the automatic tagging.
		</p>

		<h4 class="h4 py-4">How We Disclose Data</h4>
